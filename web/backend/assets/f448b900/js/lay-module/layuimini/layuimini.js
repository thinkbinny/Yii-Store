...
layui.define(["element", "jquery"], function (exports) {
    ...
    layuimini = new function () {
        ...
        this.initBgColor = function () {
            ...
            $('html').attr('class','layui-theme'+bgcolorId);
        };
        ...
        this.initTab = function () {
            var locationHref = window.location.href;//alert(locationHref);
        ...
        this.buildBgColorHtml = function () {
            ...
            for (var key=0;key<=11;key++){
                if (key === bgcolorId) {
                    html += '<li class="layui-this layui-theme-select' +key+ '" data-select-bgcolor="' + key + '">\n';
                } else {
                    html += '<li class="layui-theme-select' +key+ '" data-select-bgcolor="' + key + '">\n';
                }
                html += '<a href="javascript:;" data-skin="skin-blue" style="" class="clearfix full-opacity-hover">\n' +
                    '<div><span class="header-logo" style="display:block; width: 20%; float: left; height: 12px;"></span><span class="header-right" style="display:block; width: 80%; float: left; height: 12px;"></span></div>\n' +
                    '<div><span class="menu-left" style="display:block; width: 20%; float: left; height: 40px;"></span><span style="display:block; width: 80%; float: left; height: 40px; background: #f4f5f7;"></span></div>\n' +
                    '</a>\n' +
                    '</li>';
