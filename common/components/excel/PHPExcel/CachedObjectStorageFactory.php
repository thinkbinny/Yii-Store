...
use extensions\excel\PHPExcel\CachedObjectStorage\ICache;
/**
...
class CachedObjectStorageFactory
{
    ...
    public static function getCacheStorageMethods()
    {
        ...
        foreach (self::$storageMethods as $storageMethod) {
            $cacheStorageClass = '\extensions\excel\PHPExcel\CachedObjectStorage'.'\\' . $storageMethod;
    ...
    public static function initialize($method = self::cache_in_memory, $arguments = array())
    {
        ...
        $cacheStorageClass = '\extensions\excel\PHPExcel\CachedObjectStorage'.'\\'.$method;
        ...
        if (self::$cacheStorageMethod === null) {
            self::$cacheStorageClass = '\extensions\excel\PHPExcel\CachedObjectStorage'.'\\'. $method;
