...
use extensions\excel\PHPExcel\RichText\ITextElement;
use extensions\excel\PHPExcel\RichText\TextElement;
/**
 * RichText
 *
...
class RichText implements IComparable
{
    ...
    public function setRichTextElements($pElements = null)
    {
        if (is_array($pElements)) {
            ...
            throw new Exception("Invalid ITextElement[] array passed.");
        }
        return $this;
    }
