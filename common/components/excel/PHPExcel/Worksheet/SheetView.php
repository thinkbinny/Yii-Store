...
class SheetView
{
    ...
    public function setZoomScale($pValue = 100)
    {
        ...
        if (($pValue >= 1) || is_null($pValue)) {
            ...
            throw new \extensions\excel\PHPExcel\Exception("Scale must be greater than or equal to 1.");
        }
        return $this;
    }
    ...
    public function setView($pValue = null)
    {
        ...
        if (in_array($pValue, self::$sheetViewTypes)) {
            ...
            throw new \extensions\excel\PHPExcel\Exception("Invalid sheetview layout type.");
        }
