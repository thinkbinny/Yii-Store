<?php
namespace extensions\excel\PHPExcel\Shared\trend;
        ...
        switch ($trendType) {
            ...
            case self::TREND_POWER:
                if (!isset(self::$trendCache[$key])) {
                    $className = '\extensions\excel\PHPExcel\Shared\trend\\'.$trendType.'_Best_Fit';
            ...
            case self::TREND_POLYNOMIAL_6:
                if (!isset(self::$trendCache[$key])) {
                    ...
                    self::$trendCache[$key] = new \extensions\excel\PHPExcel\Polynomial\Best\Fit($order, $yValues, $xValues, $const);
                }
                return self::$trendCache[$key];
            ...
            case self::TREND_BEST_FIT_NO_POLY:
                ...
                foreach (self::$trendTypes as $trendMethod) {
                    $className = '\extensions\excel\PHPExcel\Shared\trend\\'.$trendMethod.'BestFit';
                ...
                if ($trendType != self::TREND_BEST_FIT_NO_POLY) {
                    foreach (self::$trendTypePolynomialOrders as $trendMethod) {
                        ...
                        $bestFit[$trendMethod] = new \extensions\excel\PHPExcel\Polynomial\Best\Fit($order, $yValues, $xValues, $const);
