...
class OLERead
{
     ...
     * @throws \extensions\excel\PHPExcel\Reader\Exception
     */
    public function read($sFileName)
    {
        // Check if file exists and is readable
        if (!is_readable($sFileName)) {
            throw new \extensions\excel\PHPExcel\Reader\Exception("Could not open " . $sFileName . " for reading! File does not exist, or it is not readable.");
        }
        ...
        if ($this->data != self::IDENTIFIER_OLE) {
            throw new \extensions\excel\PHPExcel\Reader\Exception('The filename ' . $sFileName . ' is not recognised as an OLE file');
        }
