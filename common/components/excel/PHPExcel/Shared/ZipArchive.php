...
class ZipArchive
{
    ...
    {
        $this->tempDir = \extensions\excel\PHPExcel\Shared\File::sys_get_temp_dir();
    ...
    public function addFromString($localname, $contents)
    {
        ...
        if ($res == 0) {
            throw new \extensions\excel\PHPExcel\Writer\Exception("Error zipping files : " . $this->zip->errorInfo(true));
        }
