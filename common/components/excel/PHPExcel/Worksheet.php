...
use extensions\excel\PHPExcel\Style\Color;
use extensions\excel\PHPExcel\Style\Conditional;
use extensions\excel\PHPExcel\Style\NumberFormat;
use extensions\excel\PHPExcel\Cell\DataType;
use extensions\excel\PHPExcel\Cell\DataValidation;
use extensions\excel\PHPExcel\Cell\Hyperlink;
use extensions\excel\PHPExcel;

use extensions\excel\PHPExcel\Worksheet\PageSetup;  
use extensions\excel\PHPExcel\Worksheet\PageMargins;
use extensions\excel\PHPExcel\Worksheet\HeaderFooter;
use extensions\excel\PHPExcel\Worksheet\SheetView;
use extensions\excel\PHPExcel\Worksheet\RowDimension;
use extensions\excel\PHPExcel\Worksheet\ColumnDimension;
use extensions\excel\PHPExcel\Worksheet\Protection;
use extensions\excel\PHPExcel\Worksheet\AutoFilter;
use extensions\excel\PHPExcel\Worksheet\ColumnIterator;
use extensions\excel\PHPExcel\Worksheet\RowIterator;
use extensions\excel\PHPExcel\Chart;
use extensions\excel\PHPExcel\Shared\PasswordHasher;
use extensions\excel\PHPExcel\Shared\Font;
...
class Worksheet implements IComparable
{
   ...
   /**
    ...
    {
        $CharCount = Shared_String::CountCharacters($pValue);
        if ($CharCount == 0) {
            throw new Exception('Sheet code name cannot be empty.');
        }
        // Some of the printable ASCII characters are invalid:  * : / \ ? [ ] and  first and last characters cannot be a "'"
        if ((str_replace(self::$invalidCharacters, '', $pValue) !== $pValue) ||
            (Shared_String::Substring($pValue, -1, 1)=='\'') ||
            (Shared_String::Substring($pValue, 0, 1)=='\'')) {
   ...
   /**
     ...
     *
     * @param string $pCoordinate    Coordinate of the cell
     * @param boolean $createIfNotExists  Flag indicating whether a new cell should be created if it doesnt
     ...
     * Please note that this will overwrite existing cell styles for cells in range!
     *
     * @param    array of Conditional    $pCellStyle    Cell style to duplicate
     * @param string $pRange Range of cells (i.e. "A1:B10"), or just one cell (i.e. "A1")
     * @throws Exception
     * @return Worksheet
     */
