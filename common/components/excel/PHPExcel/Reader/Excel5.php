<?php
namespace extensions\excel\PHPExcel\Reader;
...
class Excel5 extends Reader_Abstract implements IReader
{
    // ParseXL definitions
    ...
    public function load($pFilename)
    {
        ...
        if (!$this->readDataOnly) {
            foreach ($this->objFonts as $objFont) {
                if (isset($objFont->colorIndex)) {
                    $color = Excel5_Color::map($objFont->colorIndex, $this->palette, $this->version);
            ...
            foreach ($this->phpExcel->getCellXfCollection() as $objStyle) {
                ...
                if (isset($fill->startcolorIndex)) {
                    $startColor = Excel5_Color::map($fill->startcolorIndex, $this->palette, $this->version);
                    $fill->getStartColor()->setRGB($startColor['rgb']);
                }
                if (isset($fill->endcolorIndex)) {
                    $endColor = Excel5_Color::map($fill->endcolorIndex, $this->palette, $this->version);
                ...
                if (isset($top->colorIndex)) {
                    $borderTopColor = Excel5_Color::map($top->colorIndex, $this->palette, $this->version);
                    $top->getColor()->setRGB($borderTopColor['rgb']);
                }
                if (isset($right->colorIndex)) {
                    $borderRightColor = Excel5_Color::map($right->colorIndex, $this->palette, $this->version);
                    $right->getColor()->setRGB($borderRightColor['rgb']);
                }
                if (isset($bottom->colorIndex)) {
                    $borderBottomColor = Excel5_Color::map($bottom->colorIndex, $this->palette, $this->version);
                    $bottom->getColor()->setRGB($borderBottomColor['rgb']);
                }
                if (isset($left->colorIndex)) {
                    $borderLeftColor = Excel5_Color::map($left->colorIndex, $this->palette, $this->version);
                    $left->getColor()->setRGB($borderLeftColor['rgb']);
                }
                if (isset($diagonal->colorIndex)) {
                    $borderDiagonalColor = Excel5_Color::map($diagonal->colorIndex, $this->palette, $this->version);
        ...
        if (!$this->readDataOnly && $this->drawingGroupData) {
            ...
            $reader = new Excel5_Escher($escherWorkbook);
        ...
        foreach ($this->sheets as $sheet) {
            ...
            if (!$this->readDataOnly && $this->drawingData) {
                ...
                $reader = new Excel5_Escher($escherWorksheet);
    ...
    private function readXf()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            if ($this->version == self::XLS_BIFF8) {
                ...
                if ($bordersLeftStyle = Excel5_Style_Border::lookup((0x0000000F & self::getInt4d($recordData, 10)) >> 0)) {
                    $objStyle->getBorders()->getLeft()->setBorderStyle($bordersLeftStyle);
                }
                // bit: 7-4; mask: 0x000000F0; right style
                if ($bordersRightStyle = Excel5_Style_Border::lookup((0x000000F0 & self::getInt4d($recordData, 10)) >> 4)) {
                    $objStyle->getBorders()->getRight()->setBorderStyle($bordersRightStyle);
                }
                // bit: 11-8; mask: 0x00000F00; top style
                if ($bordersTopStyle = Excel5_Style_Border::lookup((0x00000F00 & self::getInt4d($recordData, 10)) >> 8)) {
                    $objStyle->getBorders()->getTop()->setBorderStyle($bordersTopStyle);
                }
                // bit: 15-12; mask: 0x0000F000; bottom style
                if ($bordersBottomStyle = Excel5_Style_Border::lookup((0x0000F000 & self::getInt4d($recordData, 10)) >> 12)) {
                ...
                if ($bordersDiagonalStyle = Excel5_Style_Border::lookup((0x01E00000 & self::getInt4d($recordData, 14)) >> 21)) {
                    $objStyle->getBorders()->getDiagonal()->setBorderStyle($bordersDiagonalStyle);
                }

                // bit: 31-26; mask: 0xFC000000 fill pattern
                if ($fillType = Excel5_Style_FillPattern::lookup((0xFC000000 & self::getInt4d($recordData, 14)) >> 26)) {
                ...
                $objStyle->getFill()->setFillType(Excel5_Style_FillPattern::lookup((0x003F0000 & $borderAndBackground) >> 16));

                // bit: 24-22; mask: 0x01C00000; bottom line style
                $objStyle->getBorders()->getBottom()->setBorderStyle(Excel5_Style_Border::lookup((0x01C00000 & $borderAndBackground) >> 22));
                ...
                $objStyle->getBorders()->getTop()->setBorderStyle(Excel5_Style_Border::lookup((0x00000007 & $borderLines) >> 0));

                // bit: 5-3; mask: 0x00000038; left line style
                $objStyle->getBorders()->getLeft()->setBorderStyle(Excel5_Style_Border::lookup((0x00000038 & $borderLines) >> 3));

                // bit: 8-6; mask: 0x000001C0; right line style
                $objStyle->getBorders()->getRight()->setBorderStyle(Excel5_Style_Border::lookup((0x000001C0 & $borderLines) >> 6));
        ...
        if (($this->getReadFilter() !== null) && $this->getReadFilter()->readCell($columnString, $row + 1, $this->phpSheet->getTitle())) {
            ...
            switch ($isError) {
                case 0: // boolean
                    ...
                    break;
                case 1: // error type
                    $value = Excel5_ErrorCode::lookup($boolErr);
        ...
        if (!$this->readDataOnly) {
            ...
            switch ($sz) {
                case 0x14:
                    ...
                    $color = Excel5_Color::map($colorIndex, $this->palette, $this->version);
    ...
    private function getNextToken($formulaData, $baseCell = 'A1')
    {
        ...
        switch ($id) {
            ...
            case 0x1C:    //    error code
                ...
                $name = 'tErr';
                $size = 2;
                $data = Excel5_ErrorCode::lookup(ord($formulaData[1]));
                break;
            case 0x1D:    //    boolean
    ...
    private static function readBIFF8Constant($valueData)
    {
        ...
        switch ($identifier) {
            ...
            case 0x10: // error code
                // offset: 1; size: 1; error code
                $value = Excel5_ErrorCode::lookup(ord($valueData[1]));
                $size = 9;
                break;
        }
        return array(
