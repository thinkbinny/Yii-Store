...
namespace extensions\weixin\mp\oauth;
 ...
 * web网页授权
 *
 * @package extensions\weixin\mp\oauth
...
class OAuth extends Driver {
     ...
     * @var string
     */
    protected $accessTokenCacheKey = 'weixin-oauth-access-token';

    /**
     * refresh_token
     * @var string
     */
    protected $refreshAccessTokenCacheKey = 'weixin-oauth-refresh-access-token';
