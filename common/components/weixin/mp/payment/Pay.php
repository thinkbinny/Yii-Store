...
class Pay extends Driver {
    ...
    public function nativeDefinedQrcode($productId){
        ...
        $codeUrl = "weixin://weixinpay/bizpayurl?appid={$params['appid']}&mch_id={$params['mch_id']}&nonce_str={$params['nonce_str']}&product_id={$productId}&time_stamp={$params['time_stamp']}&sign={$sign}";
