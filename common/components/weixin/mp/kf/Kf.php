...
class Kf extends Driver {
     ...
     * @param $weixinName string 微信账号
     * @throws Exception
     * @return boolean
     */
    public function invite($account,$weixinName){

        $response = $this->post(self::API_INVITE_KF_URL."?access_token={$this->accessToken}",['kf_account'=>$account, 'invite_weixin'=>$weixinName,])
