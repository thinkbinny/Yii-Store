...
namespace extensions\weixin\mp\server;

use extensions\weixin\helpers\Xml;
use Yii;
use extensions\weixin\core\Driver;
use yii\base\Exception;
use extensions\weixin\mp\message\Text;
use extensions\weixin\mp\encryptor\Encryptor;

/**
 * 服务器类
 * @package extensions\weixin\server
...
class Server extends Driver {
    ...
    protected function buildResponse($to,$from,$message){
        ...
        //file_put_contents(YII_DIR.'/weixin2.log', $a."\r\n", FILE_APPEND);
        if($this->conf['safeMode'] > 0){
