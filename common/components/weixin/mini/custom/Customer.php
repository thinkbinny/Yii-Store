...
/*
 * This file is part of the abei2017/yii2-weixin.
 *
 * (c) abei <abei@nai8.me>
 *
...
namespace extensions\weixin\mini\custom;
...
class Customer extends Driver {
    ...
    public function send($openId,$msgType = 'text',$data){
        ...
        $this->httpClient->formatters = ['uncodeJson'=>'abei2017\weixin\helpers\JsonFormatter'];
