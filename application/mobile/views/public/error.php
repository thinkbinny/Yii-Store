...
$seat1 = substr($statusCode,0,1);
$seat2 = substr($statusCode,1,1);
$seat3 = substr($statusCode,2,1);
...
function randomNum() {
    ...
    loop3 = setInterval(function () {
        if (i > 40) {
            clearInterval(loop3);
            document.querySelector('.thirdDigit').textContent = {$seat1};
        } else {
    ...
    loop2 = setInterval(function () {
        if (i > 80) {
            clearInterval(loop2);
            document.querySelector('.secondDigit').textContent = {$seat2};
        } else {
    ...
    loop1 = setInterval(function () {
        if (i > 100) {
            clearInterval(loop1);
            document.querySelector('.firstDigit').textContent = {$seat3};
        } else {
