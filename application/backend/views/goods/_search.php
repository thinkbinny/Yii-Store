...
<div class="page-toolbar clearfix">
    <div class="layui-btn-group ">
        ...
        echo Html::a('&nbsp;添加',['create'],[
            ...
            'data-iframe'   => "{width: '1100px', height: '98%', title: '添加商品',scrollbar:'Yse'}",
        ]);

        echo Html::a('&nbsp;上架','javascript:;',[
            'data-name'     => 'status',
            'data-value'    => '1',
    ...
    <div class="page-filter pull-right layui-search-form">
        ...
        echo $form->field($model, 'category_id',['options'=>['class'=>'layui-input-inline','style'=>'width: 180px;']])
            ->dropDownList($model->getCategoryId(),['encode' => false,'prompt' => '商品分类'])->label(false);
