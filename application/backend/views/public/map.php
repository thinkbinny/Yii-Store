...
<head>
    ...
    <style type="text/css">
        * { margin: 0px;padding: 0px;  }
        #main { height: 553px;width: 912px; border: 1px solid #5688CB; border-top: 0px;}
        #tooles {
            height: 23px;
            background: #5688CB;
            position: relative;
        ...
        #no_value {
            ...
            position: relative;
            width: 200px;}
        .search input,.poi input{border: 1px solid #e6e6e6;border-radius:2px;padding: 5px 10px !important;margin-top:0 !important;height:22px !important;}
        .search .btn,.search .btn_active{margin-top:0 !important;background: #3bb4f2;color: #fff;height: 34px;line-height: 34px;border-top-right-radius:5px;border-bottom-right-radius:5px;}
        .poi{padding-top:0;width:auto;}
        .poi .poi_note{line-height: 30px}
    </style>
<script>
...
<body>
<div style="position:relative;padding:10px;width: 920px;overflow: hidden;">
...
<script type="text/javascript">
    ...
    if(iframe === undefined){
        ...
        var parent2 = parent.document.getElementById(frameId).contentWindow;
    ...
    qq.maps.event.addListener(map, "click", function (e) {
        ...
        parent2.setCoordinate(coordinate);
